export const store = {
    ...
    description: `Phone number: 8234 5678 Superb 3 bedroom in sentosa for a very affordable price and a very nearby bus station. Please call Alex B (CEA No: R0123456) @  82345678 or the owner (83456789) to arrange for a viewing.`,
};